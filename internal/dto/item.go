...
import "wishlist-api/internal/models"
...
type CreateItemRequest struct {
	...
	Priority    models.Priority `json:"priority" validate:"required,min=1,max=5"`
}
...
type UpdateItemRequest struct {
	...
	ProductLink *string          `json:"product_link" validate:"omitempty,url"`
	Priority    *models.Priority `json:"priority" validate:"omitempty,min=1,max=5"`
}
